{**
 * plugins/importexport/nativem/issues.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.nativem.selectIssue"}
{assign var="pageCrumbTitle" value="plugins.importexport.nativem.selectIssue"}
